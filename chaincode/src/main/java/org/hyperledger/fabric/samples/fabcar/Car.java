...
public final class Car {
    ...
    public Car(@JsonProperty("id") final String id, @JsonProperty("brand") final String brand,
    ...
    public String toString() {
        return this.getClass().getSimpleName() + "@" + Integer.toHexString(hashCode()) + " [id=" + id + ", brand="
                + brand + ", model=" + model + ", color=" + color + ", owner=" + owner + "]";
    }
}
